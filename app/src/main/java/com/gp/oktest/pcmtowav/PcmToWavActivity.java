...
public class PcmToWavActivity extends BaseActivity implements View.OnClickListener {
    Button start;
    Button pause;
    Button pcmList;
    Button wavList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pcmtowav);
        ...
        switch (v.getId()) {
            case R.id.start:
                try {
                    ...
                    Toast.makeText(PcmToWavActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.pcmList:
                Intent showPcmList = new Intent(PcmToWavActivity.this, PcmToWavListActivity.class);
                showPcmList.putExtra("type", "pcm");
                startActivity(showPcmList);
                break;

            case R.id.wavList:
                Intent showWavList = new Intent(PcmToWavActivity.this, PcmToWavListActivity.class);
