...
public class VideoRecordActivity extends AppCompatActivity implements VideoRecordSurface.OnRecordListener{
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        videoRecordSurface.record(VideoRecordActivity.this,listener.getOrientationHintDegrees());
