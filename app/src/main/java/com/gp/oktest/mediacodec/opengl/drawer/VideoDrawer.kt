...
class VideoDrawer : IDrawer {
    ...
    private fun activateTexture() {
        //普通的纹理单元全部换成拓展纹理单元GLES11Ext.GL_TEXTURE_EXTERNAL_OES
    ...
    private fun getFragmentShader(): String {
        ...
        //用的是Android的拓展纹理
        //视频的画面色彩空间是YUV，而要显示到屏幕上，画面是RGB的，所以，要把视频画面渲染到屏幕上，必须把YUV转换为RGB。拓展纹理就起到了这个转换的作用
        return "#extension GL_OES_EGL_image_external : require\n" +
                ...
                //滤镜，把rgb做了一个简单的均值，然后赋值给rgb都赋值为这个均值，就可以得到一个黑白的颜色。然后赋值给片元
