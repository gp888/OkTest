...
Java_com_gp_oktest_activity_MainActivity_ffmpegInfo(JNIEnv *env, jobject  /* this */) {
...
Java_com_gp_oktest_mediacodec_FFmpegActivity_createPlayer(JNIEnv *env,
                                                       jobject  /* this */,
                                                       jstring path,
                                                       jobject surface) {
...
Java_com_gp_oktest_mediacodec_FFmpegActivity_play(JNIEnv *env,
                                               jobject  /* this */,
                                               jint player) {
...
JNIEXPORT void JNICALL
Java_com_gp_oktest_mediacodec_FFmpegActivity_pause(JNIEnv *env,
                                                jobject  /* this */,
                                                jint player) {
    Player *p = (Player *) player;
    p->pause();
...
JNIEXPORT void JNICALL
Java_com_gp_oktest_activity_MainActivity_set(JNIEnv *env, jobject thiz, jstring string) {
